...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT_planck_grid(
    KC_0,    KC_1,    KC_2,    KC_3,    _______, _______, _______, KC_F1,   KC_F2,   KC_F3,   KC_MINS, _______,
    _______, KC_4,    KC_5,    KC_6,    _______, _______, _______, KC_F4,   KC_F5,   KC_F6,   KC_SLSH, _______,
    _______, KC_7,    KC_8,    KC_9,    _______, _______, _______, KC_F7,   KC_F8,   KC_F9,    KC_F10, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, KC_MPLY, KC_SLCK,  KC_PAUS, KC_MNXT
  ),
