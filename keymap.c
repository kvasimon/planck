...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_planck_grid(
    _______, _______, _______, KC_HASH, S(KC_6),    _______, _______, S(KC_2), S(KC_8),    S(KC_9),    KC_PIPE, KC_MINS,
    _______, _______, _______, KC_PERC, KC_EXLM,    _______, _______, KC_DOT,  A(KC_8),    A(KC_9),    KC_NUBS, KC_SLSH,
    _______, _______, _______, KC_DLR,  S(KC_MINS), _______, _______, KC_COMM, S(A(KC_8)), S(A(KC_9)), KC_TILD, KC_EQL,
