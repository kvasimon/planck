...
#define GRV_RSFT MT(MOD_RSFT, KC_GRV)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------|
   * |  A   |   S  |   D  |   F  |   G  |  Tab | Entr |   H  |   J  |   K  |   L  |   Å  |
   * |------+------+------+------+------+------+------+------+------+------+------+------|
   * | Z/Ls |   X  |   C  |   V  |   B  |   ,  |   .  |   N  |   M  |   Ø  |   Æ  | '/Rs |
   * |------+------+------+------+------+------+------+------+------+------+------+------|
  ...
  [_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_A,     KC_S,    KC_D,    KC_F,    KC_G,   KC_TAB,  KC_ENT,  KC_H,  KC_J,    KC_K,    KC_L,  NO_AA,
    Z_LSFT,   KC_X,    KC_C,    KC_V,    KC_B,   KC_COMM, KC_DOT,  KC_N,  KC_M,    NO_OSLH, NO_AE, GRV_RSFT,
  ...
  [_LOWER] = LAYOUT_planck_grid(
    _______, KC_HASH, S(KC_6),    _______, LBRK,    KC_EQL,    _______, RBRK,    _______,    A(KC_7),    KC_MINS,  _______,
    _______, KC_PERC, KC_EXLM,    KC_NUBS, LPRN,    _______,   _______, RPRN,    S(KC_NUBS), S(KC_7),    KC_SLSH,  _______,
    _______, KC_DLR,  S(KC_MINS), _______, LBRC,    S(KC_EQL), S(KC_2), RBRC,    _______,    S(A(KC_7)), KC_TILDE, _______,
  ...
  [_RAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_4,    KC_5,    KC_6,    _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, _______,
